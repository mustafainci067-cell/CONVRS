...
const toolsDir = path.join(process.cwd(), 'src/app/[locale]');
const skipDirs = ['about-us', 'contact', 'cookie-policy', 'privacy-policy', 'terms-of-service', 'guides', 'image-compressor', 'pdf-merge-split', 'video-to-gif'];
...
function processFile(filePath, folderName) {
  ...
  console.log(`Fixed SEO: ${folderName}`);
}
