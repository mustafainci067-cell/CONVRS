...
const categories: NavCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Image Compressor", path: "/image-compressor", status: "active" },
      { name: "Remove Background", path: "/remove-background", status: "active" },
    ],
  },
  {
    title: "Document & Data",
    items: [
      ...
      { name: "PDF Merge & Split", path: "/pdf-merge-split", status: "active" },
      { name: "DOCX ↔ PDF", path: "/docx-to-pdf", status: "active" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "JWT Decoder", path: "/jwt-decoder", status: "active" },
      { name: "Hash Generator", path: "/hash-generator", status: "active" },
      { name: "Color Converter", path: "/color-converter", status: "active" },
    ],
  },
  {
    title: "Video & Audio",
    items: [
      { name: "MP4 ↔ WebM", path: "/mp4-to-webm", status: "active" },
      { name: "WAV ↔ MP3", path: "/wav-to-mp3", status: "active" },
      { name: "Video to MP3", path: "/video-to-mp3", status: "active" },
    ],
  },
];
