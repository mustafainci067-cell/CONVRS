...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Volume Booster?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Volume Booster",
    "faqs": [
      {
        "q": "Is Volume Booster free to use?",
        "a": "Yes, our Volume Booster is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Volume Booster Hakkında",
    "what": "Volume Booster, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Volume Booster Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Volume Booster arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Volume Booster Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Volume Booster Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Volume Booster aracını kullanmak ücretsiz mi?",
        "a": "Evet, Volume Booster aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Volume Booster",
    "what": "Volume Booster ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Volume Booster benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Volume Booster-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Volume Booster wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Volume Booster",
    "faqs": [
      {
        "q": "Ist Volume Booster kostenlos zu benutzen?",
        "a": "Ja, unser Volume Booster ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Volume Booster",
    "what": "Volume Booster es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Volume Booster",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Volume Booster.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Volume Booster?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Volume Booster",
    "faqs": [
      {
        "q": "¿Es gratis usar Volume Booster?",
        "a": "Sí, nuestro Volume Booster es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function VolumeBoosterPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
