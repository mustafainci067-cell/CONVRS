...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Svg To Png?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Svg To Png",
    "faqs": [
      {
        "q": "Is Svg To Png free to use?",
        "a": "Yes, our Svg To Png is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Svg To Png Hakkında",
    "what": "Svg To Png, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Svg To Png Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Svg To Png arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Svg To Png Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Svg To Png Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Svg To Png aracını kullanmak ücretsiz mi?",
        "a": "Evet, Svg To Png aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Svg To Png",
    "what": "Svg To Png ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Svg To Png benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Svg To Png-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Svg To Png wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Svg To Png",
    "faqs": [
      {
        "q": "Ist Svg To Png kostenlos zu benutzen?",
        "a": "Ja, unser Svg To Png ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Svg To Png",
    "what": "Svg To Png es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Svg To Png",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Svg To Png.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Svg To Png?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Svg To Png",
    "faqs": [
      {
        "q": "¿Es gratis usar Svg To Png?",
        "a": "Sí, nuestro Svg To Png es completamente gratuito para todos sin límites de uso."
      },
      {
