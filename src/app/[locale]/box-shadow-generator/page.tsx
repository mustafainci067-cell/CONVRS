...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Box Shadow Generator?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Box Shadow Generator",
    "faqs": [
      {
        "q": "Is Box Shadow Generator free to use?",
        "a": "Yes, our Box Shadow Generator is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    ...
    "whyTitle": "Neden Box Shadow Generator Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Box Shadow Generator Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Box Shadow Generator aracını kullanmak ücretsiz mi?",
        "a": "Evet, Box Shadow Generator aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Box Shadow Generator",
    ...
    "howTitle": "Wie man Box Shadow Generator benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Box Shadow Generator-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Box Shadow Generator wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Box Shadow Generator",
    "faqs": [
      {
        "q": "Ist Box Shadow Generator kostenlos zu benutzen?",
        "a": "Ja, unser Box Shadow Generator ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Box Shadow Generator",
    ...
    "howTitle": "Cómo usar Box Shadow Generator",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Box Shadow Generator.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Box Shadow Generator?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Box Shadow Generator",
    "faqs": [
      {
        "q": "¿Es gratis usar Box Shadow Generator?",
        "a": "Sí, nuestro Box Shadow Generator es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function BoxShadowGeneratorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
