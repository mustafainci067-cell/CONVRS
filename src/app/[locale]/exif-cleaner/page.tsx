...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Exif Cleaner?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Exif Cleaner",
    "faqs": [
      {
        "q": "Is Exif Cleaner free to use?",
        "a": "Yes, our Exif Cleaner is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Exif Cleaner Hakkında",
    "what": "Exif Cleaner, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Exif Cleaner Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Exif Cleaner arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Exif Cleaner Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Exif Cleaner Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Exif Cleaner aracını kullanmak ücretsiz mi?",
        "a": "Evet, Exif Cleaner aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Exif Cleaner",
    "what": "Exif Cleaner ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Exif Cleaner benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Exif Cleaner-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Exif Cleaner wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Exif Cleaner",
    "faqs": [
      {
        "q": "Ist Exif Cleaner kostenlos zu benutzen?",
        "a": "Ja, unser Exif Cleaner ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Exif Cleaner",
    "what": "Exif Cleaner es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Exif Cleaner",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Exif Cleaner.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Exif Cleaner?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Exif Cleaner",
    "faqs": [
      {
        "q": "¿Es gratis usar Exif Cleaner?",
        "a": "Sí, nuestro Exif Cleaner es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function ExifCleanerPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
