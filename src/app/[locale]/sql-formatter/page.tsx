...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Sql Formatter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Sql Formatter",
    "faqs": [
      {
        "q": "Is Sql Formatter free to use?",
        "a": "Yes, our Sql Formatter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Sql Formatter Hakkında",
    "what": "Sql Formatter, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Sql Formatter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Sql Formatter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Sql Formatter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Sql Formatter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Sql Formatter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Sql Formatter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Sql Formatter",
    "what": "Sql Formatter ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Sql Formatter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Sql Formatter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Sql Formatter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Sql Formatter",
    "faqs": [
      {
        "q": "Ist Sql Formatter kostenlos zu benutzen?",
        "a": "Ja, unser Sql Formatter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Sql Formatter",
    "what": "Sql Formatter es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Sql Formatter",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Sql Formatter.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Sql Formatter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Sql Formatter",
    "faqs": [
      {
        "q": "¿Es gratis usar Sql Formatter?",
        "a": "Sí, nuestro Sql Formatter es completamente gratuito para todos sin límites de uso."
      },
      {
