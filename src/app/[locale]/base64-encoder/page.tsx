...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Base64 Encoder?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Base64 Encoder",
    "faqs": [
      {
        "q": "Is Base64 Encoder free to use?",
        "a": "Yes, our Base64 Encoder is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Base64 Encoder Hakkında",
    "what": "Base64 Encoder, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Base64 Encoder Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Base64 Encoder arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Base64 Encoder Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Base64 Encoder Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Base64 Encoder aracını kullanmak ücretsiz mi?",
        "a": "Evet, Base64 Encoder aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Base64 Encoder",
    "what": "Base64 Encoder ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Base64 Encoder benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Base64 Encoder-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Base64 Encoder wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Base64 Encoder",
    "faqs": [
      {
        "q": "Ist Base64 Encoder kostenlos zu benutzen?",
        "a": "Ja, unser Base64 Encoder ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Base64 Encoder",
    "what": "Base64 Encoder es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Base64 Encoder",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Base64 Encoder.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Base64 Encoder?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Base64 Encoder",
    "faqs": [
      {
        "q": "¿Es gratis usar Base64 Encoder?",
        "a": "Sí, nuestro Base64 Encoder es completamente gratuito para todos sin límites de uso."
      },
      {
