...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Docx To Pdf?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Docx To Pdf",
    "faqs": [
      {
        "q": "Is Docx To Pdf free to use?",
        "a": "Yes, our Docx To Pdf is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Docx To Pdf Hakkında",
    "what": "Docx To Pdf, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Docx To Pdf Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Docx To Pdf arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Docx To Pdf Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Docx To Pdf Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Docx To Pdf aracını kullanmak ücretsiz mi?",
        "a": "Evet, Docx To Pdf aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Docx To Pdf",
    "what": "Docx To Pdf ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Docx To Pdf benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Docx To Pdf-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Docx To Pdf wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Docx To Pdf",
    "faqs": [
      {
        "q": "Ist Docx To Pdf kostenlos zu benutzen?",
        "a": "Ja, unser Docx To Pdf ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "howTitle": "Cómo usar Docx To Pdf",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Docx To Pdf.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Docx To Pdf?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Docx To Pdf",
    "faqs": [
      {
        "q": "¿Es gratis usar Docx To Pdf?",
        "a": "Sí, nuestro Docx To Pdf es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function DocxToPdfPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
