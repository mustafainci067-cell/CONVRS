...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Jpg To Webp?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Jpg To Webp",
    "faqs": [
      {
        "q": "Is Jpg To Webp free to use?",
        "a": "Yes, our Jpg To Webp is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Jpg To Webp Hakkında",
    "what": "Jpg To Webp, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Jpg To Webp Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Jpg To Webp arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Jpg To Webp Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Jpg To Webp Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Jpg To Webp aracını kullanmak ücretsiz mi?",
        "a": "Evet, Jpg To Webp aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Jpg To Webp",
    "what": "Jpg To Webp ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Jpg To Webp benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Jpg To Webp-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Jpg To Webp wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Jpg To Webp",
    "faqs": [
      {
        "q": "Ist Jpg To Webp kostenlos zu benutzen?",
        "a": "Ja, unser Jpg To Webp ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Jpg To Webp",
    "what": "Jpg To Webp es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Jpg To Webp",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Jpg To Webp.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Jpg To Webp?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Jpg To Webp",
    "faqs": [
      {
        "q": "¿Es gratis usar Jpg To Webp?",
        "a": "Sí, nuestro Jpg To Webp es completamente gratuito para todos sin límites de uso."
      },
      {
