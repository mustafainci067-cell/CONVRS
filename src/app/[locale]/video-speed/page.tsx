...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Video Speed?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Video Speed",
    "faqs": [
      {
        "q": "Is Video Speed free to use?",
        "a": "Yes, our Video Speed is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Video Speed Hakkında",
    "what": "Video Speed, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Video Speed Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Video Speed arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Video Speed Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Video Speed Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Video Speed aracını kullanmak ücretsiz mi?",
        "a": "Evet, Video Speed aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Video Speed",
    "what": "Video Speed ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Video Speed benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Video Speed-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Video Speed wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Video Speed",
    "faqs": [
      {
        "q": "Ist Video Speed kostenlos zu benutzen?",
        "a": "Ja, unser Video Speed ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Video Speed",
    "what": "Video Speed es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Video Speed",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Video Speed.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Video Speed?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Video Speed",
    "faqs": [
      {
        "q": "¿Es gratis usar Video Speed?",
        "a": "Sí, nuestro Video Speed es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function VideoSpeedPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
