...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Video To Mp3?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Video To Mp3",
    "faqs": [
      {
        "q": "Is Video To Mp3 free to use?",
        "a": "Yes, our Video To Mp3 is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Video To Mp3 Hakkında",
    "what": "Video To Mp3, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Video To Mp3 Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Video To Mp3 arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Video To Mp3 Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Video To Mp3 Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Video To Mp3 aracını kullanmak ücretsiz mi?",
        "a": "Evet, Video To Mp3 aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Video To Mp3",
    "what": "Video To Mp3 ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Video To Mp3 benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Video To Mp3-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Video To Mp3 wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Video To Mp3",
    "faqs": [
      {
        "q": "Ist Video To Mp3 kostenlos zu benutzen?",
        "a": "Ja, unser Video To Mp3 ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Video To Mp3",
    "what": "Video To Mp3 es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Video To Mp3",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Video To Mp3.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Video To Mp3?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Video To Mp3",
    "faqs": [
      {
        "q": "¿Es gratis usar Video To Mp3?",
        "a": "Sí, nuestro Video To Mp3 es completamente gratuito para todos sin límites de uso."
      },
      {
