...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Image Cropper?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Image Cropper",
    "faqs": [
      {
        "q": "Is Image Cropper free to use?",
        "a": "Yes, our Image Cropper is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Image Cropper Hakkında",
    "what": "Image Cropper, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Image Cropper Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Image Cropper arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Image Cropper Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Image Cropper Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Image Cropper aracını kullanmak ücretsiz mi?",
        "a": "Evet, Image Cropper aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Image Cropper",
    "what": "Image Cropper ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Image Cropper benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Image Cropper-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Image Cropper wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Image Cropper",
    "faqs": [
      {
        "q": "Ist Image Cropper kostenlos zu benutzen?",
        "a": "Ja, unser Image Cropper ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "whyTitle": "¿Por qué elegir nuestro Image Cropper?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Image Cropper",
    "faqs": [
      {
        "q": "¿Es gratis usar Image Cropper?",
        "a": "Sí, nuestro Image Cropper es completamente gratuito para todos sin límites de uso."
      },
      {
