...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Pdf To Jpg?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Pdf To Jpg",
    "faqs": [
      {
        "q": "Is Pdf To Jpg free to use?",
        "a": "Yes, our Pdf To Jpg is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Pdf To Jpg Hakkında",
    "what": "Pdf To Jpg, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Pdf To Jpg Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Pdf To Jpg arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Pdf To Jpg Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Pdf To Jpg Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Pdf To Jpg aracını kullanmak ücretsiz mi?",
        "a": "Evet, Pdf To Jpg aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Pdf To Jpg",
    "what": "Pdf To Jpg ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Pdf To Jpg benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Pdf To Jpg-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Pdf To Jpg wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Pdf To Jpg",
    "faqs": [
      {
        "q": "Ist Pdf To Jpg kostenlos zu benutzen?",
        "a": "Ja, unser Pdf To Jpg ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Pdf To Jpg",
    "what": "Pdf To Jpg es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Pdf To Jpg",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Pdf To Jpg.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Pdf To Jpg?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Pdf To Jpg",
    "faqs": [
      {
        "q": "¿Es gratis usar Pdf To Jpg?",
        "a": "Sí, nuestro Pdf To Jpg es completamente gratuito para todos sin límites de uso."
      },
      {
