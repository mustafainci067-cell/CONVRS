...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Xml To Json?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Xml To Json",
    "faqs": [
      {
        "q": "Is Xml To Json free to use?",
        "a": "Yes, our Xml To Json is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Xml To Json Hakkında",
    "what": "Xml To Json, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Xml To Json Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Xml To Json arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Xml To Json Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Xml To Json Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Xml To Json aracını kullanmak ücretsiz mi?",
        "a": "Evet, Xml To Json aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Xml To Json",
    "what": "Xml To Json ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Xml To Json benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Xml To Json-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Xml To Json wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Xml To Json",
    "faqs": [
      {
        "q": "Ist Xml To Json kostenlos zu benutzen?",
        "a": "Ja, unser Xml To Json ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Xml To Json",
    "what": "Xml To Json es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Xml To Json",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Xml To Json.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Xml To Json?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Xml To Json",
    "faqs": [
      {
        "q": "¿Es gratis usar Xml To Json?",
        "a": "Sí, nuestro Xml To Json es completamente gratuito para todos sin límites de uso."
      },
      {
