...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Uuid Generator?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Uuid Generator",
    "faqs": [
      {
        "q": "Is Uuid Generator free to use?",
        "a": "Yes, our Uuid Generator is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Uuid Generator Hakkında",
    "what": "Uuid Generator, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Uuid Generator Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Uuid Generator arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Uuid Generator Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Uuid Generator Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Uuid Generator aracını kullanmak ücretsiz mi?",
        "a": "Evet, Uuid Generator aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Uuid Generator",
    "what": "Uuid Generator ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Uuid Generator benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Uuid Generator-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Uuid Generator wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Uuid Generator",
    "faqs": [
      {
        "q": "Ist Uuid Generator kostenlos zu benutzen?",
        "a": "Ja, unser Uuid Generator ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Uuid Generator",
    "what": "Uuid Generator es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Uuid Generator",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Uuid Generator.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Uuid Generator?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Uuid Generator",
    "faqs": [
      {
        "q": "¿Es gratis usar Uuid Generator?",
        "a": "Sí, nuestro Uuid Generator es completamente gratuito para todos sin límites de uso."
      },
      {
