...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Json To Csv?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Json To Csv",
    "faqs": [
      {
        "q": "Is Json To Csv free to use?",
        "a": "Yes, our Json To Csv is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Json To Csv Hakkında",
    "what": "Json To Csv, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Json To Csv Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Json To Csv arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Json To Csv Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Json To Csv Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Json To Csv aracını kullanmak ücretsiz mi?",
        "a": "Evet, Json To Csv aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Json To Csv",
    "what": "Json To Csv ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Json To Csv benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Json To Csv-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Json To Csv wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Json To Csv",
    "faqs": [
      {
        "q": "Ist Json To Csv kostenlos zu benutzen?",
        "a": "Ja, unser Json To Csv ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Json To Csv",
    "what": "Json To Csv es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Json To Csv",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Json To Csv.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Json To Csv?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Json To Csv",
    "faqs": [
      {
        "q": "¿Es gratis usar Json To Csv?",
        "a": "Sí, nuestro Json To Csv es completamente gratuito para todos sin límites de uso."
      },
      {
