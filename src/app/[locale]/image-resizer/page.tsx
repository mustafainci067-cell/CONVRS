...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Image Resizer?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Image Resizer",
    "faqs": [
      {
        "q": "Is Image Resizer free to use?",
        "a": "Yes, our Image Resizer is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Image Resizer Hakkında",
    "what": "Image Resizer, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Image Resizer Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Image Resizer arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Image Resizer Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Image Resizer Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Image Resizer aracını kullanmak ücretsiz mi?",
        "a": "Evet, Image Resizer aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Image Resizer",
    "what": "Image Resizer ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Image Resizer benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Image Resizer-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Image Resizer wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Image Resizer",
    "faqs": [
      {
        "q": "Ist Image Resizer kostenlos zu benutzen?",
        "a": "Ja, unser Image Resizer ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Image Resizer",
    "what": "Image Resizer es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Image Resizer",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Image Resizer.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Image Resizer?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Image Resizer",
    "faqs": [
      {
        "q": "¿Es gratis usar Image Resizer?",
        "a": "Sí, nuestro Image Resizer es completamente gratuito para todos sin límites de uso."
      },
      {
