...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Html Encode Decode?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Html Encode Decode",
    "faqs": [
      {
        "q": "Is Html Encode Decode free to use?",
        "a": "Yes, our Html Encode Decode is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Html Encode Decode Hakkında",
    "what": "Html Encode Decode, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Html Encode Decode Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Html Encode Decode arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Html Encode Decode Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Html Encode Decode Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Html Encode Decode aracını kullanmak ücretsiz mi?",
        "a": "Evet, Html Encode Decode aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Html Encode Decode",
    "what": "Html Encode Decode ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Html Encode Decode benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Html Encode Decode-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Html Encode Decode wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Html Encode Decode",
    "faqs": [
      {
        "q": "Ist Html Encode Decode kostenlos zu benutzen?",
        "a": "Ja, unser Html Encode Decode ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Html Encode Decode",
    "what": "Html Encode Decode es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Html Encode Decode",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Html Encode Decode.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Html Encode Decode?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Html Encode Decode",
    "faqs": [
      {
        "q": "¿Es gratis usar Html Encode Decode?",
        "a": "Sí, nuestro Html Encode Decode es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function HtmlEncodeDecodePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
