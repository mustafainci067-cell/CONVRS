...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Audio Trimmer?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Audio Trimmer",
    "faqs": [
      {
        "q": "Is Audio Trimmer free to use?",
        "a": "Yes, our Audio Trimmer is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    ...
    "howTitle": "Audio Trimmer Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Audio Trimmer arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Audio Trimmer Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Audio Trimmer Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Audio Trimmer aracını kullanmak ücretsiz mi?",
        "a": "Evet, Audio Trimmer aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    ...
    "howTitle": "Wie man Audio Trimmer benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Audio Trimmer-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Audio Trimmer wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Audio Trimmer",
    "faqs": [
      {
        "q": "Ist Audio Trimmer kostenlos zu benutzen?",
        "a": "Ja, unser Audio Trimmer ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "howTitle": "Cómo usar Audio Trimmer",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Audio Trimmer.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Audio Trimmer?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Audio Trimmer",
    "faqs": [
      {
        "q": "¿Es gratis usar Audio Trimmer?",
        "a": "Sí, nuestro Audio Trimmer es completamente gratuito para todos sin límites de uso."
      },
      {
