...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Markdown To Html?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Markdown To Html",
    "faqs": [
      {
        "q": "Is Markdown To Html free to use?",
        "a": "Yes, our Markdown To Html is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Markdown To Html Hakkında",
    "what": "Markdown To Html, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Markdown To Html Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Markdown To Html arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Markdown To Html Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Markdown To Html Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Markdown To Html aracını kullanmak ücretsiz mi?",
        "a": "Evet, Markdown To Html aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Markdown To Html",
    "what": "Markdown To Html ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Markdown To Html benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Markdown To Html-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Markdown To Html wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Markdown To Html",
    "faqs": [
      {
        "q": "Ist Markdown To Html kostenlos zu benutzen?",
        "a": "Ja, unser Markdown To Html ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Markdown To Html",
    "what": "Markdown To Html es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Markdown To Html",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Markdown To Html.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Markdown To Html?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Markdown To Html",
    "faqs": [
      {
        "q": "¿Es gratis usar Markdown To Html?",
        "a": "Sí, nuestro Markdown To Html es completamente gratuito para todos sin límites de uso."
      },
      {
