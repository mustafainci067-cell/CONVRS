...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Js Keycode?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Js Keycode",
    "faqs": [
      {
        "q": "Is Js Keycode free to use?",
        "a": "Yes, our Js Keycode is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Js Keycode Hakkında",
    "what": "Js Keycode, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Js Keycode Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Js Keycode arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Js Keycode Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Js Keycode Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Js Keycode aracını kullanmak ücretsiz mi?",
        "a": "Evet, Js Keycode aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Js Keycode",
    "what": "Js Keycode ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Js Keycode benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Js Keycode-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Js Keycode wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Js Keycode",
    "faqs": [
      {
        "q": "Ist Js Keycode kostenlos zu benutzen?",
        "a": "Ja, unser Js Keycode ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Js Keycode",
    "what": "Js Keycode es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Js Keycode",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Js Keycode.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Js Keycode?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Js Keycode",
    "faqs": [
      {
        "q": "¿Es gratis usar Js Keycode?",
        "a": "Sí, nuestro Js Keycode es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function JsKeycodePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
