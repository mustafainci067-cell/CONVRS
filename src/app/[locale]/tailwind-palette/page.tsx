...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Tailwind Palette?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Tailwind Palette",
    "faqs": [
      {
        "q": "Is Tailwind Palette free to use?",
        "a": "Yes, our Tailwind Palette is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Tailwind Palette Hakkında",
    "what": "Tailwind Palette, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Tailwind Palette Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Tailwind Palette arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Tailwind Palette Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Tailwind Palette Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Tailwind Palette aracını kullanmak ücretsiz mi?",
        "a": "Evet, Tailwind Palette aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Tailwind Palette",
    "what": "Tailwind Palette ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Tailwind Palette benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Tailwind Palette-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Tailwind Palette wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Tailwind Palette",
    "faqs": [
      {
        "q": "Ist Tailwind Palette kostenlos zu benutzen?",
        "a": "Ja, unser Tailwind Palette ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Tailwind Palette",
    "what": "Tailwind Palette es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Tailwind Palette",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Tailwind Palette.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Tailwind Palette?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Tailwind Palette",
    "faqs": [
      {
        "q": "¿Es gratis usar Tailwind Palette?",
        "a": "Sí, nuestro Tailwind Palette es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function TailwindPalettePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
