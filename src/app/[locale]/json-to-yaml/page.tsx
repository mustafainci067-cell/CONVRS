...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Json To Yaml?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Json To Yaml",
    "faqs": [
      {
        "q": "Is Json To Yaml free to use?",
        "a": "Yes, our Json To Yaml is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Json To Yaml Hakkında",
    "what": "Json To Yaml, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Json To Yaml Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Json To Yaml arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Json To Yaml Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Json To Yaml Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Json To Yaml aracını kullanmak ücretsiz mi?",
        "a": "Evet, Json To Yaml aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Json To Yaml",
    "what": "Json To Yaml ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Json To Yaml benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Json To Yaml-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Json To Yaml wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Json To Yaml",
    "faqs": [
      {
        "q": "Ist Json To Yaml kostenlos zu benutzen?",
        "a": "Ja, unser Json To Yaml ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Json To Yaml",
    "what": "Json To Yaml es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Json To Yaml",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Json To Yaml.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Json To Yaml?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Json To Yaml",
    "faqs": [
      {
        "q": "¿Es gratis usar Json To Yaml?",
        "a": "Sí, nuestro Json To Yaml es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function JsonToYamlPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
