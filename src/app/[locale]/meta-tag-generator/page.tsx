...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Meta Tag Generator?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Meta Tag Generator",
    "faqs": [
      {
        "q": "Is Meta Tag Generator free to use?",
        "a": "Yes, our Meta Tag Generator is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Meta Tag Generator Hakkında",
    "what": "Meta Tag Generator, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Meta Tag Generator Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Meta Tag Generator arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Meta Tag Generator Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Meta Tag Generator Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Meta Tag Generator aracını kullanmak ücretsiz mi?",
        "a": "Evet, Meta Tag Generator aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Meta Tag Generator",
    "what": "Meta Tag Generator ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Meta Tag Generator benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Meta Tag Generator-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Meta Tag Generator wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Meta Tag Generator",
    "faqs": [
      {
        "q": "Ist Meta Tag Generator kostenlos zu benutzen?",
        "a": "Ja, unser Meta Tag Generator ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Meta Tag Generator",
    "what": "Meta Tag Generator es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Meta Tag Generator",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Meta Tag Generator.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Meta Tag Generator?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Meta Tag Generator",
    "faqs": [
      {
        "q": "¿Es gratis usar Meta Tag Generator?",
        "a": "Sí, nuestro Meta Tag Generator es completamente gratuito para todos sin límites de uso."
      },
      {
