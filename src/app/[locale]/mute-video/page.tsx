...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Mute Video?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Mute Video",
    "faqs": [
      {
        "q": "Is Mute Video free to use?",
        "a": "Yes, our Mute Video is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Mute Video Hakkında",
    "what": "Mute Video, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Mute Video Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Mute Video arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Mute Video Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Mute Video Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Mute Video aracını kullanmak ücretsiz mi?",
        "a": "Evet, Mute Video aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Mute Video",
    "what": "Mute Video ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Mute Video benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Mute Video-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Mute Video wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Mute Video",
    "faqs": [
      {
        "q": "Ist Mute Video kostenlos zu benutzen?",
        "a": "Ja, unser Mute Video ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Mute Video",
    "what": "Mute Video es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Mute Video",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Mute Video.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Mute Video?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Mute Video",
    "faqs": [
      {
        "q": "¿Es gratis usar Mute Video?",
        "a": "Sí, nuestro Mute Video es completamente gratuito para todos sin límites de uso."
      },
      {
