...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Image To Base64?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Image To Base64",
    "faqs": [
      {
        "q": "Is Image To Base64 free to use?",
        "a": "Yes, our Image To Base64 is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Image To Base64 Hakkında",
    "what": "Image To Base64, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Image To Base64 Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Image To Base64 arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Image To Base64 Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Image To Base64 Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Image To Base64 aracını kullanmak ücretsiz mi?",
        "a": "Evet, Image To Base64 aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Image To Base64",
    "what": "Image To Base64 ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Image To Base64 benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Image To Base64-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Image To Base64 wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Image To Base64",
    "faqs": [
      {
        "q": "Ist Image To Base64 kostenlos zu benutzen?",
        "a": "Ja, unser Image To Base64 ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Image To Base64",
    "what": "Image To Base64 es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Image To Base64",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Image To Base64.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Image To Base64?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Image To Base64",
    "faqs": [
      {
        "q": "¿Es gratis usar Image To Base64?",
        "a": "Sí, nuestro Image To Base64 es completamente gratuito para todos sin límites de uso."
      },
      {
