...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Pdf To Text?",
    "why": [
    ...
    "faqs": [
      {
        "q": "Is Pdf To Text free to use?",
        "a": "Yes, our Pdf To Text is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Pdf To Text Hakkında",
    "what": "Pdf To Text, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Pdf To Text Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Pdf To Text arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Pdf To Text Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Pdf To Text Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Pdf To Text aracını kullanmak ücretsiz mi?",
        "a": "Evet, Pdf To Text aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Pdf To Text",
    "what": "Pdf To Text ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Pdf To Text benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Pdf To Text-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Pdf To Text wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Pdf To Text",
    "faqs": [
      {
        "q": "Ist Pdf To Text kostenlos zu benutzen?",
        "a": "Ja, unser Pdf To Text ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Pdf To Text",
    "what": "Pdf To Text es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Pdf To Text",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Pdf To Text.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Pdf To Text?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Pdf To Text",
    "faqs": [
      {
        "q": "¿Es gratis usar Pdf To Text?",
        "a": "Sí, nuestro Pdf To Text es completamente gratuito para todos sin límites de uso."
      },
      {
