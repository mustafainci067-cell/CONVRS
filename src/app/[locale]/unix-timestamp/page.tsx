...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Unix Timestamp?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Unix Timestamp",
    "faqs": [
      {
        "q": "Is Unix Timestamp free to use?",
        "a": "Yes, our Unix Timestamp is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Unix Timestamp Hakkında",
    "what": "Unix Timestamp, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Unix Timestamp Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Unix Timestamp arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Unix Timestamp Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Unix Timestamp Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Unix Timestamp aracını kullanmak ücretsiz mi?",
        "a": "Evet, Unix Timestamp aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Unix Timestamp",
    "what": "Unix Timestamp ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Unix Timestamp benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Unix Timestamp-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Unix Timestamp wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Unix Timestamp",
    "faqs": [
      {
        "q": "Ist Unix Timestamp kostenlos zu benutzen?",
        "a": "Ja, unser Unix Timestamp ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Unix Timestamp",
    "what": "Unix Timestamp es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Unix Timestamp",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Unix Timestamp.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Unix Timestamp?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Unix Timestamp",
    "faqs": [
      {
        "q": "¿Es gratis usar Unix Timestamp?",
        "a": "Sí, nuestro Unix Timestamp es completamente gratuito para todos sin límites de uso."
      },
      {
