...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Word Counter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Word Counter",
    "faqs": [
      {
        "q": "Is Word Counter free to use?",
        "a": "Yes, our Word Counter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Word Counter Hakkında",
    "what": "Word Counter, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Word Counter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Word Counter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Word Counter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Word Counter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Word Counter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Word Counter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Word Counter",
    "what": "Word Counter ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Word Counter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Word Counter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Word Counter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Word Counter",
    "faqs": [
      {
        "q": "Ist Word Counter kostenlos zu benutzen?",
        "a": "Ja, unser Word Counter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Word Counter",
    "what": "Word Counter es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Word Counter",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Word Counter.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Word Counter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Word Counter",
    "faqs": [
      {
        "q": "¿Es gratis usar Word Counter?",
        "a": "Sí, nuestro Word Counter es completamente gratuito para todos sin límites de uso."
      },
      {
