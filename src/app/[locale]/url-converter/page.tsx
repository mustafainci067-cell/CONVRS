...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Url Converter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Url Converter",
    "faqs": [
      {
        "q": "Is Url Converter free to use?",
        "a": "Yes, our Url Converter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Url Converter Hakkında",
    "what": "Url Converter, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Url Converter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Url Converter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Url Converter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Url Converter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Url Converter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Url Converter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Url Converter",
    "what": "Url Converter ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Url Converter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Url Converter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Url Converter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Url Converter",
    "faqs": [
      {
        "q": "Ist Url Converter kostenlos zu benutzen?",
        "a": "Ja, unser Url Converter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "whyTitle": "¿Por qué elegir nuestro Url Converter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Url Converter",
    "faqs": [
      {
        "q": "¿Es gratis usar Url Converter?",
        "a": "Sí, nuestro Url Converter es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function UrlConverterPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
