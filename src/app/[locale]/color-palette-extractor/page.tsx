...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Color Palette Extractor?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Color Palette Extractor",
    "faqs": [
      {
        "q": "Is Color Palette Extractor free to use?",
        "a": "Yes, our Color Palette Extractor is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Color Palette Extractor Hakkında",
    "what": "Color Palette Extractor, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Color Palette Extractor Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Color Palette Extractor arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Color Palette Extractor Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Color Palette Extractor Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Color Palette Extractor aracını kullanmak ücretsiz mi?",
        "a": "Evet, Color Palette Extractor aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Color Palette Extractor",
    "what": "Color Palette Extractor ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Color Palette Extractor benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Color Palette Extractor-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Color Palette Extractor wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Color Palette Extractor",
    "faqs": [
      {
        "q": "Ist Color Palette Extractor kostenlos zu benutzen?",
        "a": "Ja, unser Color Palette Extractor ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Color Palette Extractor",
    "what": "Color Palette Extractor es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Color Palette Extractor",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Color Palette Extractor.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Color Palette Extractor?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Color Palette Extractor",
    "faqs": [
      {
        "q": "¿Es gratis usar Color Palette Extractor?",
        "a": "Sí, nuestro Color Palette Extractor es completamente gratuito para todos sin límites de uso."
      },
      {
