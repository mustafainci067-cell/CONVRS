...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Image Filters?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Image Filters",
    "faqs": [
      {
        "q": "Is Image Filters free to use?",
        "a": "Yes, our Image Filters is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Image Filters Hakkında",
    "what": "Image Filters, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Image Filters Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Image Filters arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Image Filters Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Image Filters Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Image Filters aracını kullanmak ücretsiz mi?",
        "a": "Evet, Image Filters aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Image Filters",
    "what": "Image Filters ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Image Filters benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Image Filters-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Image Filters wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Image Filters",
    "faqs": [
      {
        "q": "Ist Image Filters kostenlos zu benutzen?",
        "a": "Ja, unser Image Filters ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Image Filters",
    "what": "Image Filters es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Image Filters",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Image Filters.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Image Filters?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Image Filters",
    "faqs": [
      {
        "q": "¿Es gratis usar Image Filters?",
        "a": "Sí, nuestro Image Filters es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function ImageFiltersPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
