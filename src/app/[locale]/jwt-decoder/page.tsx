...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Jwt Decoder?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Jwt Decoder",
    "faqs": [
      {
        "q": "Is Jwt Decoder free to use?",
        "a": "Yes, our Jwt Decoder is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Jwt Decoder Hakkında",
    "what": "Jwt Decoder, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Jwt Decoder Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Jwt Decoder arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Jwt Decoder Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Jwt Decoder Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Jwt Decoder aracını kullanmak ücretsiz mi?",
        "a": "Evet, Jwt Decoder aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Jwt Decoder",
    "what": "Jwt Decoder ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Jwt Decoder benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Jwt Decoder-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Jwt Decoder wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Jwt Decoder",
    "faqs": [
      {
        "q": "Ist Jwt Decoder kostenlos zu benutzen?",
        "a": "Ja, unser Jwt Decoder ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Jwt Decoder",
    "what": "Jwt Decoder es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Jwt Decoder",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Jwt Decoder.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Jwt Decoder?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Jwt Decoder",
    "faqs": [
      {
        "q": "¿Es gratis usar Jwt Decoder?",
        "a": "Sí, nuestro Jwt Decoder es completamente gratuito para todos sin límites de uso."
      },
      {
