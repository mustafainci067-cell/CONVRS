...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Qr Generator?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Qr Generator",
    "faqs": [
      {
        "q": "Is Qr Generator free to use?",
        "a": "Yes, our Qr Generator is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Qr Generator Hakkında",
    "what": "Qr Generator, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Qr Generator Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Qr Generator arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Qr Generator Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Qr Generator Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Qr Generator aracını kullanmak ücretsiz mi?",
        "a": "Evet, Qr Generator aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Qr Generator",
    "what": "Qr Generator ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Qr Generator benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Qr Generator-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Qr Generator wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Qr Generator",
    "faqs": [
      {
        "q": "Ist Qr Generator kostenlos zu benutzen?",
        "a": "Ja, unser Qr Generator ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Qr Generator",
    "what": "Qr Generator es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Qr Generator",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Qr Generator.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Qr Generator?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Qr Generator",
    "faqs": [
      {
        "q": "¿Es gratis usar Qr Generator?",
        "a": "Sí, nuestro Qr Generator es completamente gratuito para todos sin límites de uso."
      },
      {
