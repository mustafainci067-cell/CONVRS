...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Mp4 To Webm?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Mp4 To Webm",
    "faqs": [
      {
        "q": "Is Mp4 To Webm free to use?",
        "a": "Yes, our Mp4 To Webm is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Mp4 To Webm Hakkında",
    "what": "Mp4 To Webm, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Mp4 To Webm Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Mp4 To Webm arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Mp4 To Webm Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Mp4 To Webm Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Mp4 To Webm aracını kullanmak ücretsiz mi?",
        "a": "Evet, Mp4 To Webm aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Mp4 To Webm",
    "what": "Mp4 To Webm ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Mp4 To Webm benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Mp4 To Webm-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Mp4 To Webm wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Mp4 To Webm",
    "faqs": [
      {
        "q": "Ist Mp4 To Webm kostenlos zu benutzen?",
        "a": "Ja, unser Mp4 To Webm ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Mp4 To Webm",
    "what": "Mp4 To Webm es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Mp4 To Webm",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Mp4 To Webm.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Mp4 To Webm?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Mp4 To Webm",
    "faqs": [
      {
        "q": "¿Es gratis usar Mp4 To Webm?",
        "a": "Sí, nuestro Mp4 To Webm es completamente gratuito para todos sin límites de uso."
      },
      {
