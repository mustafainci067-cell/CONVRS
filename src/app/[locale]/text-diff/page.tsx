...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Text Diff?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Text Diff",
    "faqs": [
      {
        "q": "Is Text Diff free to use?",
        "a": "Yes, our Text Diff is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Text Diff Hakkında",
    "what": "Text Diff, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Text Diff Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Text Diff arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Text Diff Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Text Diff Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Text Diff aracını kullanmak ücretsiz mi?",
        "a": "Evet, Text Diff aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Text Diff",
    "what": "Text Diff ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Text Diff benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Text Diff-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Text Diff wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Text Diff",
    "faqs": [
      {
        "q": "Ist Text Diff kostenlos zu benutzen?",
        "a": "Ja, unser Text Diff ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Text Diff",
    "what": "Text Diff es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Text Diff",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Text Diff.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Text Diff?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Text Diff",
    "faqs": [
      {
        "q": "¿Es gratis usar Text Diff?",
        "a": "Sí, nuestro Text Diff es completamente gratuito para todos sin límites de uso."
      },
      {
