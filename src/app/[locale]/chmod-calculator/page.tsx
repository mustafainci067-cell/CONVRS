...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Chmod Calculator?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Chmod Calculator",
    "faqs": [
      {
        "q": "Is Chmod Calculator free to use?",
        "a": "Yes, our Chmod Calculator is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Chmod Calculator Hakkında",
    "what": "Chmod Calculator, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Chmod Calculator Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Chmod Calculator arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Chmod Calculator Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Chmod Calculator Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Chmod Calculator aracını kullanmak ücretsiz mi?",
        "a": "Evet, Chmod Calculator aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Chmod Calculator",
    "what": "Chmod Calculator ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Chmod Calculator benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Chmod Calculator-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Chmod Calculator wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Chmod Calculator",
    "faqs": [
      {
        "q": "Ist Chmod Calculator kostenlos zu benutzen?",
        "a": "Ja, unser Chmod Calculator ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Chmod Calculator",
    "what": "Chmod Calculator es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Chmod Calculator",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Chmod Calculator.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Chmod Calculator?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Chmod Calculator",
    "faqs": [
      {
        "q": "¿Es gratis usar Chmod Calculator?",
        "a": "Sí, nuestro Chmod Calculator es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function ChmodCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
