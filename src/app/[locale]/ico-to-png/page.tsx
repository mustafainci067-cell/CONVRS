...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Ico To Png?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Ico To Png",
    "faqs": [
      {
        "q": "Is Ico To Png free to use?",
        "a": "Yes, our Ico To Png is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Ico To Png Hakkında",
    "what": "Ico To Png, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Ico To Png Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Ico To Png arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Ico To Png Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Ico To Png Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Ico To Png aracını kullanmak ücretsiz mi?",
        "a": "Evet, Ico To Png aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Ico To Png",
    "what": "Ico To Png ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Ico To Png benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Ico To Png-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Ico To Png wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Ico To Png",
    "faqs": [
      {
        "q": "Ist Ico To Png kostenlos zu benutzen?",
        "a": "Ja, unser Ico To Png ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Ico To Png",
    "what": "Ico To Png es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Ico To Png",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Ico To Png.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Ico To Png?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Ico To Png",
    "faqs": [
      {
        "q": "¿Es gratis usar Ico To Png?",
        "a": "Sí, nuestro Ico To Png es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function IcoToPngPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
