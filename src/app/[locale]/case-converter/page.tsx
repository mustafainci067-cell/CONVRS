...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Case Converter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Case Converter",
    "faqs": [
      {
        "q": "Is Case Converter free to use?",
        "a": "Yes, our Case Converter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Case Converter Hakkında",
    "what": "Case Converter, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Case Converter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Case Converter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Case Converter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Case Converter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Case Converter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Case Converter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Case Converter",
    "what": "Case Converter ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Case Converter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Case Converter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Case Converter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Case Converter",
    "faqs": [
      {
        "q": "Ist Case Converter kostenlos zu benutzen?",
        "a": "Ja, unser Case Converter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "whyTitle": "¿Por qué elegir nuestro Case Converter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Case Converter",
    "faqs": [
      {
        "q": "¿Es gratis usar Case Converter?",
        "a": "Sí, nuestro Case Converter es completamente gratuito para todos sin límites de uso."
      },
      {
