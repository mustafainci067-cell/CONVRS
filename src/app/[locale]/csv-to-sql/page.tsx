...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Csv To Sql?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Csv To Sql",
    "faqs": [
      {
        "q": "Is Csv To Sql free to use?",
        "a": "Yes, our Csv To Sql is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Csv To Sql Hakkında",
    "what": "Csv To Sql, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Csv To Sql Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Csv To Sql arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Csv To Sql Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Csv To Sql Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Csv To Sql aracını kullanmak ücretsiz mi?",
        "a": "Evet, Csv To Sql aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Csv To Sql",
    "what": "Csv To Sql ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Csv To Sql benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Csv To Sql-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Csv To Sql wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Csv To Sql",
    "faqs": [
      {
        "q": "Ist Csv To Sql kostenlos zu benutzen?",
        "a": "Ja, unser Csv To Sql ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Csv To Sql",
    "what": "Csv To Sql es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Csv To Sql",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Csv To Sql.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Csv To Sql?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Csv To Sql",
    "faqs": [
      {
        "q": "¿Es gratis usar Csv To Sql?",
        "a": "Sí, nuestro Csv To Sql es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function CsvToSqlPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
