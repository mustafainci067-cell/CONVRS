...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Watermark Adder?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Watermark Adder",
    "faqs": [
      {
        "q": "Is Watermark Adder free to use?",
        "a": "Yes, our Watermark Adder is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Watermark Adder Hakkında",
    "what": "Watermark Adder, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Watermark Adder Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Watermark Adder arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Watermark Adder Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Watermark Adder Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Watermark Adder aracını kullanmak ücretsiz mi?",
        "a": "Evet, Watermark Adder aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Watermark Adder",
    "what": "Watermark Adder ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Watermark Adder benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Watermark Adder-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Watermark Adder wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Watermark Adder",
    "faqs": [
      {
        "q": "Ist Watermark Adder kostenlos zu benutzen?",
        "a": "Ja, unser Watermark Adder ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Watermark Adder",
    "what": "Watermark Adder es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Watermark Adder",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Watermark Adder.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Watermark Adder?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Watermark Adder",
    "faqs": [
      {
        "q": "¿Es gratis usar Watermark Adder?",
        "a": "Sí, nuestro Watermark Adder es completamente gratuito para todos sin límites de uso."
      },
      {
...
export default async function WatermarkAdderPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
