...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Lorem Ipsum?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Lorem Ipsum",
    "faqs": [
      {
        "q": "Is Lorem Ipsum free to use?",
        "a": "Yes, our Lorem Ipsum is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Lorem Ipsum Hakkında",
    "what": "Lorem Ipsum, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Lorem Ipsum Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Lorem Ipsum arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Lorem Ipsum Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Lorem Ipsum Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Lorem Ipsum aracını kullanmak ücretsiz mi?",
        "a": "Evet, Lorem Ipsum aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Lorem Ipsum",
    "what": "Lorem Ipsum ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Lorem Ipsum benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Lorem Ipsum-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Lorem Ipsum wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Lorem Ipsum",
    "faqs": [
      {
        "q": "Ist Lorem Ipsum kostenlos zu benutzen?",
        "a": "Ja, unser Lorem Ipsum ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Lorem Ipsum",
    "what": "Lorem Ipsum es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Lorem Ipsum",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Lorem Ipsum.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Lorem Ipsum?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Lorem Ipsum",
    "faqs": [
      {
        "q": "¿Es gratis usar Lorem Ipsum?",
        "a": "Sí, nuestro Lorem Ipsum es completamente gratuito para todos sin límites de uso."
      },
      {
