...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Css Js Minifier?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Css Js Minifier",
    "faqs": [
      {
        "q": "Is Css Js Minifier free to use?",
        "a": "Yes, our Css Js Minifier is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Css Js Minifier Hakkında",
    "what": "Css Js Minifier, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Css Js Minifier Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Css Js Minifier arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Css Js Minifier Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Css Js Minifier Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Css Js Minifier aracını kullanmak ücretsiz mi?",
        "a": "Evet, Css Js Minifier aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Css Js Minifier",
    "what": "Css Js Minifier ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Css Js Minifier benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Css Js Minifier-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Css Js Minifier wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Css Js Minifier",
    "faqs": [
      {
        "q": "Ist Css Js Minifier kostenlos zu benutzen?",
        "a": "Ja, unser Css Js Minifier ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Css Js Minifier",
    "what": "Css Js Minifier es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Css Js Minifier",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Css Js Minifier.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Css Js Minifier?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Css Js Minifier",
    "faqs": [
      {
        "q": "¿Es gratis usar Css Js Minifier?",
        "a": "Sí, nuestro Css Js Minifier es completamente gratuito para todos sin límites de uso."
      },
      {
