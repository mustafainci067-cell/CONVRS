...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "steps": [
      "Select or input your data into the Json Formatter interface.",
    ...
    "whyTitle": "Why Choose Our Json Formatter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Json Formatter",
    "faqs": [
      {
        "q": "Is Json Formatter free to use?",
        "a": "Yes, our Json Formatter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    ...
    "howTitle": "Json Formatter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Json Formatter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Json Formatter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Json Formatter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Json Formatter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Json Formatter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    ...
    "howTitle": "Wie man Json Formatter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Json Formatter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Json Formatter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Json Formatter",
    "faqs": [
      {
        "q": "Ist Json Formatter kostenlos zu benutzen?",
        "a": "Ja, unser Json Formatter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Json Formatter",
    ...
    "howTitle": "Cómo usar Json Formatter",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Json Formatter.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Json Formatter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Json Formatter",
    "faqs": [
      {
        "q": "¿Es gratis usar Json Formatter?",
        "a": "Sí, nuestro Json Formatter es completamente gratuito para todos sin límites de uso."
      },
      {
