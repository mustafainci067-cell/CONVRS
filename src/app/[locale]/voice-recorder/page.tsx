...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Voice Recorder?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Voice Recorder",
    "faqs": [
      {
        "q": "Is Voice Recorder free to use?",
        "a": "Yes, our Voice Recorder is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Voice Recorder Hakkında",
    "what": "Voice Recorder, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Voice Recorder Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Voice Recorder arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Voice Recorder Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Voice Recorder Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Voice Recorder aracını kullanmak ücretsiz mi?",
        "a": "Evet, Voice Recorder aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Voice Recorder",
    "what": "Voice Recorder ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Voice Recorder benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Voice Recorder-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Voice Recorder wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Voice Recorder",
    "faqs": [
      {
        "q": "Ist Voice Recorder kostenlos zu benutzen?",
        "a": "Ja, unser Voice Recorder ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    "title": "Acerca de Voice Recorder",
    "what": "Voice Recorder es una potente utilidad en línea gratuita diseñada para hacer que su flujo de trabajo sea más rápido y eficiente. Ya sea que sea un desarrollador, diseñador o usuario ocasional, puede procesar sus archivos de manera fácil y segura. Todas las operaciones se realizan localmente en su navegador, lo que significa que sus datos nunca se suben a servidores externos, asegurando 100% de privacidad y un rendimiento ultrarrápido.",
    "howTitle": "Cómo usar Voice Recorder",
    "steps": [
      "Seleccione o ingrese sus datos en la interfaz de Voice Recorder.",
    ...
    "whyTitle": "¿Por qué elegir nuestro Voice Recorder?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Voice Recorder",
    "faqs": [
      {
        "q": "¿Es gratis usar Voice Recorder?",
        "a": "Sí, nuestro Voice Recorder es completamente gratuito para todos sin límites de uso."
      },
      {
