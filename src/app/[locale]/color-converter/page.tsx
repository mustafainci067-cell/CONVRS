...
const seoContent: Record<string, { title: string, what: string, howTitle: string, steps: string[], whyTitle: string, why: string[], faqTitle: string, faqs: {q: string, a: string}[] }> = {
  "en": {
    ...
    "whyTitle": "Why Choose Our Color Converter?",
    "why": [
    ...
    "faqTitle": "Frequently Asked Questions about Color Converter",
    "faqs": [
      {
        "q": "Is Color Converter free to use?",
        "a": "Yes, our Color Converter is completely free for everyone with no usage limits."
      },
      {
  ...
  "tr": {
    "title": "Color Converter Hakkında",
    "what": "Color Converter, iş akışınızı hızlandırmak ve daha verimli hale getirmek için tasarlanmış güçlü ve ücretsiz bir çevrimiçi araçtır. İster geliştirici, ister tasarımcı veya günlük bir kullanıcı olun, dosyalarınızı kolayca ve güvenle işleyebilirsiniz. Tüm işlemler yerel olarak tarayıcınızda gerçekleştirilir, yani verileriniz hiçbir zaman harici bir sunucuya yüklenmez. Bu da %100 gizlilik ve şimşek hızında performans sağlar.",
    "howTitle": "Color Converter Nasıl Kullanılır?",
    "steps": [
      "Verilerinizi veya dosyalarınızı Color Converter arayüzüne seçin veya girin.",
    ...
    "whyTitle": "Neden Color Converter Aracımızı Seçmelisiniz?",
    "why": [
    ...
    "faqTitle": "Color Converter Hakkında Sıkça Sorulan Sorular",
    "faqs": [
      {
        "q": "Color Converter aracını kullanmak ücretsiz mi?",
        "a": "Evet, Color Converter aracımız herkes için tamamen ücretsizdir ve kullanım sınırı yoktur."
      },
      {
  ...
  "de": {
    "title": "Über Color Converter",
    "what": "Color Converter ist ein leistungsstarkes, kostenloses Online-Dienstprogramm, das entwickelt wurde, um Ihren Workflow schneller und effizienter zu gestalten. Egal, ob Sie Entwickler, Designer oder Gelegenheitsnutzer sind, Sie können Ihre Dateien einfach und sicher verarbeiten. Alle Vorgänge werden lokal in Ihrem Browser ausgeführt, was bedeutet, dass Ihre Daten niemals auf externe Server hochgeladen werden, was 100%ige Privatsphäre und blitzschnelle Leistung gewährleistet.",
    "howTitle": "Wie man Color Converter benutzt",
    "steps": [
      "Wählen Sie Ihre Daten aus oder geben Sie sie in die Color Converter-Oberfläche ein.",
    ...
    "whyTitle": "Warum unseren Color Converter wählen?",
    "why": [
    ...
    "faqTitle": "Häufig gestellte Fragen zu Color Converter",
    "faqs": [
      {
        "q": "Ist Color Converter kostenlos zu benutzen?",
        "a": "Ja, unser Color Converter ist für alle völlig kostenlos und hat keine Nutzungsbeschränkungen."
      },
      {
  ...
  "es": {
    ...
    "whyTitle": "¿Por qué elegir nuestro Color Converter?",
    "why": [
    ...
    "faqTitle": "Preguntas frecuentes sobre Color Converter",
    "faqs": [
      {
        "q": "¿Es gratis usar Color Converter?",
        "a": "Sí, nuestro Color Converter es completamente gratuito para todos sin límites de uso."
      },
      {
